      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        {isEditing ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="col-span-2">
                ...
                <input
                  ...
                  className={`w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 ${errors.startupName ? "border-red-500" : "border-gray-300"}`}
                />
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  step="0.01"
                  className={`w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 ${errors.amountToRaise ? "border-red-500" : "border-gray-300"}`}
                />
                {errors.amountToRaise && <p className="mt-1 text-sm text-red-500">{errors.amountToRaise}</p>}
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  min="0"
                  max="100"
                  className={`w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 ${errors.equityPercentage ? "border-red-500" : "border-gray-300"}`}
                />
                {errors.equityPercentage && <p className="mt-1 text-sm text-red-500">{errors.equityPercentage}</p>}
              </div>
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 ${errors.sector ? "border-red-500" : "border-gray-300"}`}
                >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 ${errors.endDate ? "border-red-500" : "border-gray-300"}`}
                />
              ...
              <div className="col-span-2">
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows="4"
                  className={`w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-green-500 ${errors.reason ? "border-red-500" : "border-gray-300"}`}
                ></textarea>
          ...
          <div className="space-y-6">
            <div>
              <h2 className="text-xl font-bold text-gray-800 mb-4">{profile.startupName}</h2>
            ...
            <div>
              <h3 className="text-sm font-medium text-gray-500 mb-1">Reason for Fundraising</h3>
              <p className="text-gray-700">{profile.reason}</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div>
                <h3 className="text-sm font-medium text-gray-500 mb-1">Amount to Raise</h3>
                <p className="text-xl font-bold text-gray-800">{profile.amountToRaise} ETH</p>
              </div>

              <div>
                <h3 className="text-sm font-medium text-gray-500 mb-1">Equity Offered</h3>
                <p className="text-xl font-bold text-gray-800">{profile.equityPercentage}%</p>
              </div>

              <div>
                <h3 className="text-sm font-medium text-gray-500 mb-1">Start Date</h3>
                <p className="text-gray-700">{new Date(profile.startDate).toLocaleDateString()}</p>
              </div>

              <div>
                <h3 className="text-sm font-medium text-gray-500 mb-1">End Date</h3>
                <p className="text-gray-700">{new Date(profile.endDate).toLocaleDateString()}</p>
              </div>
            </div>
          </div>
        )}
